...
class SpaceShipCRUDControllerIT {
    ...
    @MockBean
    SpaceShipApplicationService spaceShipApplicationService;
    ...
    class FindByIdTest {
        ...
        void givenNonExistingSpaceShip_ThenReturnNotFound() throws Exception {
            ...
            Mockito.when(spaceShipApplicationService.findSpaceShipById(Mockito.any()))
            ...
            Mockito.verify(spaceShipApplicationService, Mockito.atLeastOnce())
                    .findSpaceShipById(SpaceShipFactory.SPACE_SHIP_ID);
        ...
        void givenExistingSpaceShip_ThenReturnIt() throws Exception {
            ...
            Mockito.when(spaceShipApplicationService.findSpaceShipById(ArgumentMatchers.anyLong()))
            ...
            Mockito.verify(spaceShipApplicationService, Mockito.times(1))
                    .findSpaceShipById(ArgumentMatchers.anyLong());
    ...
    class CreateGroupTest {
        ...
        void givenRequestingUserWithPermissions_ThenOperationIsAccepted() throws Exception {
            ...
            Mockito.when(spaceShipApplicationService.createSpaceShip(ArgumentMatchers.any()))
                    .thenReturn(domainToResponse);
            ...
            Mockito.verify(spaceShipApplicationService, Mockito.times(1)).createSpaceShip(any());
            final String response = result.getResponse().getContentAsString();
    ...
    class ModifySpaceShip {
        ...
        void givenRequestingUserWithPermissions_ThenOperationIsAccepted() throws Exception {
            ...
            Mockito.when(
                            spaceShipApplicationService.updateSpaceShip(ArgumentMatchers.anyLong(), ArgumentMatchers.any()))
                    .thenReturn(domainToResponse);
    ...
    class deleteSpaceShipTest {
        ...
        void givenRequestingUserWithPermissions_ThenOperationIsAccepted() throws Exception {
            ...
            // @formatter:on
            Mockito.verify(spaceShipApplicationService, Mockito.times(1))
                    .deleteSpaceShipById(ArgumentMatchers.anyLong());
        }
        ...
        void givenRequestingUserWithoutPermissions_ThenOperationIsDenied() {
            ...
            try {
                ...
                mockMvc.perform(MockMvcRequestBuilders.delete(RequestMappings.API + RequestMappings.SPACESHIPS + "/"+SpaceShipFactory.SPACE_SHIP_ID)
                        ...
                        .andExpect(MockMvcResultMatchers.status().isForbidden());
                // @formatter:on
                Mockito.verify(spaceShipApplicationService, Mockito.times(0))
                        .deleteSpaceShipById(ArgumentMatchers.anyLong());
                // @formatter:on
                Assertions.fail();
            } catch (final Exception e) {
    ...
    class deleteAllSpaceShipsTest {
        ...
        void givenRequestingUserWithPermissions_ThenOperationIsAccepted() throws Exception {
            ...
            mockMvc.perform(MockMvcRequestBuilders.delete(RequestMappings.API + RequestMappings.SPACESHIPS)
                    ...
                    .andExpect(MockMvcResultMatchers.status().isNoContent());
            // @formatter:on
            Mockito.verify(spaceShipApplicationService, Mockito.times(1)).deleteAllSpaceShips();
        }
        ...
        void givenRequestingUserWithoutPermissions_ThenOperationIsDenied() {
            ...
            try {
                ...
                mockMvc.perform(MockMvcRequestBuilders.delete(RequestMappings.API + RequestMappings.SPACESHIPS)
                        ...
                        .andExpect(MockMvcResultMatchers.status().isForbidden());
                // @formatter:on
                Mockito.verify(spaceShipApplicationService, Mockito.times(0)).deleteAllSpaceShips();
                // @formatter:on
                Assertions.fail();
            } catch (final Exception e) {
                Assertions.assertInstanceOf(AccessDeniedException.class, e.getCause());
